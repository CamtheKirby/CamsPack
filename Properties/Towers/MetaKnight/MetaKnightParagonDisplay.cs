...
namespace MetaKnight.Displays
{
    public class MetaKnightParagonDisplay : ModTowerDisplay<MetaKnight>
    {
        /// <summary>
        /// All classes that derive from ModContent MUST have a zero argument constructor to work
        /// </summary>
        public MetaKnightParagonDisplay()
        {
        }

        public MetaKnightParagonDisplay(int i)
        {
        ...
        public override string Name => nameof(MetaKnightParagonDisplay) + ParagonDisplayIndex;
        ...
        public override IEnumerable<ModContent> Load()
        {
            ...
            {
                yield return new MetaKnightParagonDisplay(i);
            }
        }
        ...
        {
            Set2DTexture(node, "MergeDisplay");
        }
    }
}