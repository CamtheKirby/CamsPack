...
namespace Firey.Displays
{
    public class FireyParagonDisplay : ModTowerDisplay<Firey>
    {
        /// <summary>
        /// All classes that derive from ModContent MUST have a zero argument constructor to work
        /// </summary>
        public FireyParagonDisplay()
        {
        }

        public FireyParagonDisplay(int i)
        {
        ...
        public override string Name => nameof(FireyParagonDisplay) + ParagonDisplayIndex;
        ...
        public override IEnumerable<ModContent> Load()
        {
            ...
            {
                yield return new FireyParagonDisplay(i);
            }
        }
        ...
        {
            Set2DTexture(node, "FireyBDisplay");
        }
    }
}