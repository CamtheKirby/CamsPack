...
{
    public class ThanksgivingMonkeyParagonDisplay : ModTowerDisplay<TGMonkey.ThanksgivingMonkey>
    {
        /// <summary>
        /// All classes that derive from ModContent MUST have a zero argument constructor to work
        /// </summary>
        public ThanksgivingMonkeyParagonDisplay()
        {
        }

        public ThanksgivingMonkeyParagonDisplay(int i)
        {
        ...
        public override string Name => nameof(ThanksgivingMonkeyParagonDisplay) + ParagonDisplayIndex;
        ...
        public override IEnumerable<ModContent> Load()
        {
            ...
            {
                yield return new ThanksgivingMonkeyParagonDisplay(i);
            }
        }
